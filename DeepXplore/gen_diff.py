...
from CNNTestGen.Models.Model1 import Model1
from CNNTestGen.Models.Model2 import Model2
from CNNTestGen.Models.Model3 import Model3
from CNNTestGen.DeepXplore.configs import bcolors
from CNNTestGen.DeepXplore.utils import *
from CNNTestGen.MaXplore.utils_max import get_layer_max_stat, get_layer_model, update_test_max_stat

# read the parameter
# argument parsing
# python gen_diff.py blackout 1 0.1 10 20 50 0
...
# write outputs
sys.stdout = open("./output/deepxplore.txt", "w")
...
for _ in range(args.seeds):
    ...
    update_test_max_stat(model1, gen_img, model_max_dict)
    ...
    grads = normalize(tf.keras.backend.gradients(final_loss, input_tensor)[0])
    ...
    for iters in range(args.grad_iterations):
        ...
        if not predictions1 == predictions2 == predictions3:
            ...
            ratio_dict = get_layer_max_stat(model1, gen_img, model_max_dict, None, layer_names, intermediate_layer_model)
            print(ratio_dict)
            gen_input_num += 1
            break
print('Total generated input:', gen_input_num)
